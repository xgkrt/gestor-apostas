  ...
  return (
    <Card className={cn(
      ...
      <div className="flex items-end justify-between">
        <h3 className={cn("text-2xl font-bold text-card-foreground", valueClassName)}>{value}</h3>
        {trend && (
          <span className={cn(
